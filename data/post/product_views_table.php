<?php !defined("APPPATH") && exit();?><?php require(dirname(__FILE__)."/product_var.php"); ?><?php $Dict = terms_get_post_category($Model->getPostId()); ?>
<table class="sl-table">  
                <?php if( $Model->getPostTitle() != ""){ ?>            <tr class="column post_title">
                <td class="name">标题</td>
