...
<input type="hidden" name="PostKey10" value="<?php echo $_Model->getPostKey10(); ?>"/>
        ...
        <tr class="column post_alias">
            <td class="name">别名</td>
            <td class="field">
                
                                    <input type="text" tip="用于url访问" reg="" style="" class="input PostAlias" name="PostAlias" value="<?php echo $_Model->getPostAlias(); ?>"/>
                                        <span class="parameters-memo">用于url访问</span>
            </td>
            <td class="memo"></td>
        </tr>
